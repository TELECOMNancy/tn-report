...
\def\reportAuthorFirstName{Jon} % Prénom de l'élève
\def\reportAuthorLastName{Snow} % Nom de l'élève
\def\reportStudentId{20140410}  % Numéro de carte d'étudiant de l'élève
...
\def\reportAuthorAddress{numéro rue, VILLE, code postal} % Adresse de l'élève
\def\reportAuthorPhone{téléphone} % Téléphone de l'élève 
\def\reportAuthorEmail{jon@castleblack.com} % Courriel de l'élève
