...
\def\reportAuthorCity{code postal, VILLE}
\def\reportAuthorPhone{téléphone}
\def\reportAuthorEmail{jon@castleblack.com}

\def\reportCompany{Home Box Office}
\def\reportCompanyAddress{numéro rue}
\def\reportCompanyCity{code postal, VILLE}
