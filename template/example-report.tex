...
\insertSupervisorValidationAgreement{Stark, Eddard}{Snow, Jon}
                            % {<Encadrant industriel> Nom, Prénom}{<Elève> Nom, Prénom} 
% You may insert several agreement in case of multiple supervisors
%\insertSupervisorValidationAgreement{Lannister, Tyrion}{Snow, Jon}
\cleardoublepage
